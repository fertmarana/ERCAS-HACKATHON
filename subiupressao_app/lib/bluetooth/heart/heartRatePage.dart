                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (BuildContext context, int position) {
                      ...
                      return Card(
                        child: ListTile(
                          leading: position == 0 ||
                              (heartData[position].get_hearetRate() ==
                                  heartData[position - 1].get_hearetRate()) ?
                          Icon(Icons.circle_outlined, color: Colors.blue,)
                              : heartData[position].get_hearetRate() >
                              heartData[position - 1].get_hearetRate() ?
                          Icon(Icons.arrow_upward_sharp, color: Colors.green,)
                              : Icon(
                            Icons.arrow_downward_sharp, color: Colors.red,),
                          title: Text(
